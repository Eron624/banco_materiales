...
function ponerNumControl() {
    let user = document.getElementById("user");
    let correo = document.getElementById("correo");

    user.value = extraerNum(correo.value);
}

function registroNuevo() {
    let correo = document.getElementById("correo").value;
    let usuario = extraerNum(correo);
    ...
    if (usuario) {
        ...
        fetch(url,
            ...
            .then(datos => {
                ...
                let right = 0;
                if (error == 1) {
                    if (mensaje.includes("usuario.PRIMARY")) {
                        msg_cuerpo_3.innerHTML = 'No. Control Ya Registrado';
                        msg_titulo_3.innerHTML = 'ERROR 1';
                    }
                    else if (mensaje.includes("usuario.correo")) {
                        msg_cuerpo_3.innerHTML = 'Correo Ya Registrado';
                        msg_titulo_3.innerHTML = 'ERROR 1';
                    }
                    else {
    ...
    msg_cuerpo_3.innerHTML = 'Correo Y Num. Control Inválidos';
    msg_titulo_3.innerHTML = 'ERROR';
    msg_3.showModal();
}